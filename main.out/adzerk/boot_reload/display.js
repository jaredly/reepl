...
var attr = cljs.core.nth.call(null,vec__11427,(0),null);
var v = cljs.core.nth.call(null,vec__11427,(1),null);
...
var args11428 = [];
var len__7511__auto___11431 = arguments.length;
var i__7512__auto___11432 = (0);
while(true){
if((i__7512__auto___11432 < len__7511__auto___11431)){
args11428.push((arguments[i__7512__auto___11432]));

var G__11433 = (i__7512__auto___11432 + (1));
i__7512__auto___11432 = G__11433;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args11428.length)].join('')));
...
var len__7511__auto___11436 = arguments.length;
var i__7512__auto___11437 = (0);
while(true){
if((i__7512__auto___11437 < len__7511__auto___11436)){
args__7518__auto__.push((arguments[i__7512__auto___11437]));

var G__11438 = (i__7512__auto___11437 + (1));
i__7512__auto___11437 = G__11438;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__7519__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq11435){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11435));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__11439){
var map__11443 = p__11439;
...
var data = map__11443__$1;
var message = cljs.core.get.call(null,map__11443__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__11443__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__11443__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__11445 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__11445,goog.events.EventType.CLICK,((function (G__11445,map__11443,map__11443__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__11445,map__11443,map__11443__$1,data,message,line,file))
);

return G__11445;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__11446){
var map__11450 = p__11446;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__11453){
var map__11457 = p__11453;
...
var messages = map__11457__$1;
var warnings = cljs.core.get.call(null,map__11457__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__11457__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__11459 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__11459,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__11459,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__11460){
var map__11463 = p__11460;
var map__11463__$1 = ((((!((map__11463 == null)))?((((map__11463.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11463.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11463):map__11463);
var messages = map__11463__$1;
var warnings = cljs.core.get.call(null,map__11463__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__11463__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__11463,map__11463__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__11463,map__11463__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__11463,map__11463__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__11463,map__11463__$1,messages,warnings,exception))
;
