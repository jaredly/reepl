...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__11481,opts){
...
var files = cljs.core.get.call(null,map__11482__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__7511__auto___11488 = arguments.length;
var i__7512__auto___11489 = (0);
while(true){
if((i__7512__auto___11489 < len__7511__auto___11488)){
args__7518__auto__.push((arguments[i__7512__auto___11489]));

var G__11490 = (i__7512__auto___11489 + (1));
i__7512__auto___11489 = G__11490;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__11486){
var vec__11487 = p__11486;
var opts = cljs.core.nth.call(null,vec__11487,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__11487,opts){
return (function (evt){
...
});})(conn,vec__11487,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__11487,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__11487,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__11487,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq11484){
var G__11485 = cljs.core.first.call(null,seq11484);
var seq11484__$1 = cljs.core.next.call(null,seq11484);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__11485,seq11484__$1);
});
