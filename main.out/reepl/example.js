...
var _STAR_print_newline_STAR_19928_19930 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_19929_19931 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_19928_19930,_STAR_print_fn_STAR_19929_19931,sb__7427__auto__,doc){
return (function (x__7428__auto__){
return sb__7427__auto__.append(x__7428__auto__);
});})(_STAR_print_newline_STAR_19928_19930,_STAR_print_fn_STAR_19929_19931,sb__7427__auto__,doc))
;

try{reepl.replumb.print_doc.call(null,doc);
}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_19929_19931;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_19928_19930;
}
...
reepl.example.default_settings = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"vim","vim",764723904),false,new cljs.core.Keyword(null,"warning-as-error","warning-as-error",1347418166),true,new cljs.core.Keyword(null,"parinfer","parinfer",1893066885),true], null);
...
try{return cljs.core.merge.call(null,reepl.example.default_settings,cljs.core.js__GT_clj.call(null,JSON.parse(val),new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true));
...
cljs.core.add_watch.call(null,reepl.example.settings,new cljs.core.Keyword(null,"settings","settings",1556144875),(function (p1__19935_SHARP_,p2__19936_SHARP_,p3__19937_SHARP_,p4__19934_SHARP_){
return reepl.example.save_settings.call(null,p4__19934_SHARP_);
}));
reepl.example.pi_count = cljs.core.atom.call(null,(0));
reepl.example.my_st = cljs.js.empty_state.call(null);
reepl.example.jsc_run = (function reepl$example$jsc_run(source,cb){
return cljs.js.eval_str.call(null,reepl.example.my_st,source,new cljs.core.Symbol(null,"stuff","stuff",-411032116,null),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"eval","eval",-1103567905),cljs.js.js_eval,new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Symbol(null,"cljs.user","cljs.user",877795071,null),new cljs.core.Keyword(null,"context","context",-830191113),new cljs.core.Keyword(null,"statement","statement",-32780863),new cljs.core.Keyword(null,"def-emits-var","def-emits-var",-1551927320),true], null),(function (result){
...
return cb.call(null,true,new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(result));
}
}));
});
reepl.example.main_view = (function reepl$example$main_view(){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [reepl.example.view,new cljs.core.Keyword(null,"main","main",-2117802661),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [reepl.example.view,new cljs.core.Keyword(null,"box","box",1530920394),new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [reepl.core.repl,new cljs.core.Keyword(null,"execute","execute",-129499188),(function (p1__19938_SHARP_,p2__19939_SHARP_){
return reepl.replumb.run_repl.call(null,p1__19938_SHARP_,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"warning-as-error","warning-as-error",1347418166),new cljs.core.Keyword(null,"warning-as-error","warning-as-error",1347418166).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,reepl.example.settings))], null),p2__19939_SHARP_);
}),new cljs.core.Keyword(null,"complete-word","complete-word",1063206084),reepl.replumb.process_apropos,new cljs.core.Keyword(null,"get-docs","get-docs",-698720007),reepl.replumb.process_doc,new cljs.core.Keyword(null,"state","state",-1988618099),reepl.example.repl_state,new cljs.core.Keyword(null,"show-value-opts","show-value-opts",-412296519),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"showers","showers",1548575441),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reepl.show_devtools.show_devtools,cljs.core.partial.call(null,reepl.show_function.show_fn_with_docs,reepl.example.maybe_fn_docs)], null)], null),new cljs.core.Keyword(null,"js-cm-opts","js-cm-opts",1231776640),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"mode","mode",654403691),(cljs.core.truth_(new cljs.core.Keyword(null,"parinfer","parinfer",1893066885).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,reepl.example.settings)))?"clojure-parinfer":"clojure"),new cljs.core.Keyword(null,"keyMap","keyMap",945500512),(cljs.core.truth_(new cljs.core.Keyword(null,"vim","vim",764723904).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,reepl.example.settings)))?"vim":"default"),new cljs.core.Keyword(null,"showCursorWhenSelecting","showCursorWhenSelecting",169880137),true], null),new cljs.core.Keyword(null,"on-cm-init","on-cm-init",105207782),(function (p1__19940_SHARP_){
...
})], null)], null),"Parinfer"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.Keyword(null,"label","label",1718410804).cljs$core$IFn$_invoke$arity$1(reepl.example.styles)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"checked","checked",-50955819),new cljs.core.Keyword(null,"warning-as-error","warning-as-error",1347418166).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,reepl.example.settings)),new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.Keyword(null,"checkbox","checkbox",1612615655).cljs$core$IFn$_invoke$arity$1(reepl.example.styles),new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (){
return cljs.core.swap_BANG_.call(null,reepl.example.settings,cljs.core.update,new cljs.core.Keyword(null,"warning-as-error","warning-as-error",1347418166),cljs.core.not);
})], null)], null),"Warning as error"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"href","href",-793805698),"https://github.com/jaredly/reepl",new cljs.core.Keyword(null,"target","target",253001721),new cljs.core.Keyword(null,"_blank","_blank",1070304072),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.Keyword(null,"link","link",-1769163468).cljs$core$IFn$_invoke$arity$1(reepl.example.styles)], null),"Github"], null)], null)], null);
});
