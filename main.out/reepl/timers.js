...
reepl.timers.check_ival = (function reepl$timers$check_ival(state,p__16128){
var vec__16130 = p__16128;
var name = cljs.core.nth.call(null,vec__16130,(0),null);
var timer = cljs.core.nth.call(null,vec__16130,(1),null);
if(cljs.core.not.call(null,reepl.timers.timer_ready.call(null,timer))){
return state;
} else {
var or__6453__auto__ = new cljs.core.Keyword(null,"handler","handler",-195596612).cljs$core$IFn$_invoke$arity$1(timer).call(null,state);
...
return cljs.core.assoc.call(null,options,new cljs.core.Keyword(null,"update","update",1045576396),(function (p1__16131_SHARP_){
return reepl.timers.update_fn.call(null,new cljs.core.Keyword(null,"update","update",1045576396).cljs$core$IFn$_invoke$arity$1(options),p1__16131_SHARP_);
}));
});
