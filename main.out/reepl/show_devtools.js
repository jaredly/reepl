...
var vec__19920 = clojure.string.split.call(null,line,":");
var k = cljs.core.nth.call(null,vec__19920,(0),null);
var v = cljs.core.nth.call(null,vec__19920,(1),null);
...
if(cljs.core.not.call(null,reepl.show_devtools.js_array_QMARK_.call(null,p1__19921_SHARP_))){
return p1__19921_SHARP_;
} else {
return reepl$show_devtools$show_el.call(null,p1__19921_SHARP_,show_value);
}
});})(type,opts,children))
,children));
}
