...
var vec__18931 = axis;
var a_x = cljs.core.nth.call(null,vec__18931,(0),null);
var a_y = cljs.core.nth.call(null,vec__18931,(1),null);
var a_z = cljs.core.nth.call(null,vec__18931,(2),null);
var vec__18932 = v;
var x = cljs.core.nth.call(null,vec__18932,(0),null);
var y = cljs.core.nth.call(null,vec__18932,(1),null);
var z = cljs.core.nth.call(null,vec__18932,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__18933,p__18934){
var vec__18937 = p__18933;
var u1 = cljs.core.nth.call(null,vec__18937,(0),null);
var u2 = cljs.core.nth.call(null,vec__18937,(1),null);
var u3 = cljs.core.nth.call(null,vec__18937,(2),null);
var vec__18938 = p__18934;
var v1 = cljs.core.nth.call(null,vec__18938,(0),null);
var v2 = cljs.core.nth.call(null,vec__18938,(1),null);
var v3 = cljs.core.nth.call(null,vec__18938,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__18939_SHARP_){
return (p1__18939_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__18940_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__18941_SHARP_,angle_lr),angle_ud);
...
var map__18948 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__18948__$1 = ((((!((map__18948 == null)))?((((map__18948.cljs$lang$protocol_mask$partition0$ & (64))) || (map__18948.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18948):map__18948);
var up = cljs.core.get.call(null,map__18948__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__18948__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__18950 = cljs.core._EQ_;
var expr__18951 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__18950.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__18951))){
return straight;
} else {
if(cljs.core.truth_(pred__18950.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__18951))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__18950.call(null,quil.middlewares.navigation_3d.space,expr__18951))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__18950.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__18951))){
return up;
} else {
if(cljs.core.truth_(pred__18950.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__18951))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__18950.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__18951))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__18948,map__18948__$1,up,straight){
return (function (p1__18942_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__18942_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__18948,map__18948__$1,up,straight))
);
} else {
return state;
}
...
return (function (p1__18953_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__18953_SHARP_);
});})(initial_state))
);
});
/**
...
var map__18959_18964 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__18959_18965__$1 = ((((!((map__18959_18964 == null)))?((((map__18959_18964.cljs$lang$protocol_mask$partition0$ & (64))) || (map__18959_18964.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18959_18964):map__18959_18964);
var vec__18960_18966 = cljs.core.get.call(null,map__18959_18965__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_18967 = cljs.core.nth.call(null,vec__18960_18966,(0),null);
var c_y_18968 = cljs.core.nth.call(null,vec__18960_18966,(1),null);
var c_z_18969 = cljs.core.nth.call(null,vec__18960_18966,(2),null);
var vec__18961_18970 = cljs.core.get.call(null,map__18959_18965__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_18971 = cljs.core.nth.call(null,vec__18961_18970,(0),null);
var u_y_18972 = cljs.core.nth.call(null,vec__18961_18970,(1),null);
var u_z_18973 = cljs.core.nth.call(null,vec__18961_18970,(2),null);
var vec__18962_18974 = cljs.core.get.call(null,map__18959_18965__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_18975 = cljs.core.nth.call(null,vec__18962_18974,(0),null);
var p_y_18976 = cljs.core.nth.call(null,vec__18962_18974,(1),null);
var p_z_18977 = cljs.core.nth.call(null,vec__18962_18974,(2),null);
quil.core.camera.call(null,p_x_18975,p_y_18976,p_z_18977,(p_x_18975 + c_x_18967),(p_y_18976 + c_y_18968),(p_z_18977 + c_z_18969),u_x_18971,u_y_18972,u_z_18973);
