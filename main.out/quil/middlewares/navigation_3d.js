...
var vec__15193 = axis;
var a_x = cljs.core.nth.call(null,vec__15193,(0),null);
var a_y = cljs.core.nth.call(null,vec__15193,(1),null);
var a_z = cljs.core.nth.call(null,vec__15193,(2),null);
var vec__15194 = v;
var x = cljs.core.nth.call(null,vec__15194,(0),null);
var y = cljs.core.nth.call(null,vec__15194,(1),null);
var z = cljs.core.nth.call(null,vec__15194,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__15195,p__15196){
var vec__15199 = p__15195;
var u1 = cljs.core.nth.call(null,vec__15199,(0),null);
var u2 = cljs.core.nth.call(null,vec__15199,(1),null);
var u3 = cljs.core.nth.call(null,vec__15199,(2),null);
var vec__15200 = p__15196;
var v1 = cljs.core.nth.call(null,vec__15200,(0),null);
var v2 = cljs.core.nth.call(null,vec__15200,(1),null);
var v3 = cljs.core.nth.call(null,vec__15200,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__15201_SHARP_){
return (p1__15201_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__15202_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__15203_SHARP_,angle_lr),angle_ud);
...
var map__15210 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__15210__$1 = ((((!((map__15210 == null)))?((((map__15210.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15210.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15210):map__15210);
var up = cljs.core.get.call(null,map__15210__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__15210__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4423__auto__ = (function (){var pred__15212 = cljs.core._EQ_;
var expr__15213 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__15212.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__15213))){
return straight;
} else {
if(cljs.core.truth_(pred__15212.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__15213))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__15212.call(null,quil.middlewares.navigation_3d.space,expr__15213))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__15212.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__15213))){
return up;
} else {
if(cljs.core.truth_(pred__15212.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__15213))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__15212.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__15213))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4423__auto__,map__15210,map__15210__$1,up,straight){
return (function (p1__15204_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__15204_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4423__auto__,map__15210,map__15210__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__15215_SHARP_);
});})(initial_state))
);
});
/**
...
var map__15221_15226 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__15221_15227__$1 = ((((!((map__15221_15226 == null)))?((((map__15221_15226.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15221_15226.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15221_15226):map__15221_15226);
var vec__15222_15228 = cljs.core.get.call(null,map__15221_15227__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_15229 = cljs.core.nth.call(null,vec__15222_15228,(0),null);
var c_y_15230 = cljs.core.nth.call(null,vec__15222_15228,(1),null);
var c_z_15231 = cljs.core.nth.call(null,vec__15222_15228,(2),null);
var vec__15223_15232 = cljs.core.get.call(null,map__15221_15227__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_15233 = cljs.core.nth.call(null,vec__15223_15232,(0),null);
var u_y_15234 = cljs.core.nth.call(null,vec__15223_15232,(1),null);
var u_z_15235 = cljs.core.nth.call(null,vec__15223_15232,(2),null);
var vec__15224_15236 = cljs.core.get.call(null,map__15221_15227__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_15237 = cljs.core.nth.call(null,vec__15224_15236,(0),null);
var p_y_15238 = cljs.core.nth.call(null,vec__15224_15236,(1),null);
var p_z_15239 = cljs.core.nth.call(null,vec__15224_15236,(2),null);
quil.core.camera.call(null,p_x_15237,p_y_15238,p_z_15239,(p_x_15237 + c_x_15229),(p_y_15238 + c_y_15230),(p_z_15239 + c_z_15231),u_x_15233,u_y_15234,u_z_15235);
