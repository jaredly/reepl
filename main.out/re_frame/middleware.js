...
while (G__16975__i < G__16975__a.length) {G__16975__a[G__16975__i] = arguments[G__16975__i + 0]; ++G__16975__i;}
  args = new cljs.core.IndexedSeq(G__16975__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__16976){
...
return cljs.core.get_in.call(null,new_db,p1__16977_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__16978_SHARP_){
return cljs.core.get_in.call(null,db,p1__16978_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__16979__i = 0, G__16979__a = new Array(arguments.length -  2);
while (G__16979__i < G__16979__a.length) {G__16979__a[G__16979__i] = arguments[G__16979__i + 2]; ++G__16979__i;}
  in_paths = new cljs.core.IndexedSeq(G__16979__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__16980){
var f = cljs.core.first(arglist__16980);
arglist__16980 = cljs.core.next(arglist__16980);
var out_path = cljs.core.first(arglist__16980);
var in_paths = cljs.core.rest(arglist__16980);
