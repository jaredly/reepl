...
while (G__13315__i < G__13315__a.length) {G__13315__a[G__13315__i] = arguments[G__13315__i + 0]; ++G__13315__i;}
  args = new cljs.core.IndexedSeq(G__13315__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__13316){
var args = cljs.core.seq(arglist__13316);
...
return cljs.core.get_in.call(null,new_db,p1__13317_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__13318_SHARP_){
return cljs.core.get_in.call(null,db,p1__13318_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__13319__i < G__13319__a.length) {G__13319__a[G__13319__i] = arguments[G__13319__i + 2]; ++G__13319__i;}
  in_paths = new cljs.core.IndexedSeq(G__13319__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__13320){
var f = cljs.core.first(arglist__13320);
arglist__13320 = cljs.core.next(arglist__13320);
var out_path = cljs.core.first(arglist__13320);
var in_paths = cljs.core.rest(arglist__13320);
